...
**技术验证报告**: `docs/architecture/技术验证总结.md`
...
| 文档 | 路径 | 说明 |
|------|------|------|
| 系统架构设计 | `docs/architecture/系统架构设计.md` | 3800+ 行完整架构设计 |
| 技术验证总结 | `docs/architecture/技术验证总结.md` | 技术验证结论汇总 |
| 部署运维指南 | `docs/deployment/部署运维指南.md` | 生产环境部署与运维 |
| 用户快速上手 | `docs/user/用户快速上手.md` | 5 分钟快速上手指南 |
| 完整操作手册 | `docs/完整操作手册.md` | 完整操作与 API 说明 |
| 后续开发计划 | `docs/后续开发计划.md` | 后续开发路线图 |
| MCP服务暴露设计 | `docs/MCP服务暴露设计.md` | MCP 服务暴露方案 |
| MCP集成使用说明 | `docs/MCP集成使用说明.md` | MCP 集成使用指南 |
| 小白入门指南 | `小白入门指南.md` | 零基础小白完全入门 |
